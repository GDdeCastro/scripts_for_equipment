...
def fscan(dir, id1, freqs, measuring_time, sleep_time,cpl, index):
...
def main(index):
    ...
    dir = "D:/LQMEC-Julio-group/Python/Data/Data/Users/Guilherme/gold_iron_data/" + date + str(time.time()) + "("+str(round(V,1))+" V)"+str(round(float(t_ref),1))+"K/"
    # dir = "D:/LQMEC-Julio-group/Python/Data/Data/Users/Guilherme/" + "("+str(round(V,1))+" V)/"
    # dir = "D:/LQMEC-Julio-group/Python/Data/Data/Users/Guilherme/13-12-20211639420075.4389074(4.5 V)40.0K/"
    # dir = "C:/Users/lqmec/Documents/data/automatic_sweeps/21-10-2021(4.0 V)/"
    Path(dir).mkdir(parents=True,exist_ok=True)
    # info(dir,sr1,AB, phase, ref, harmonic,gain,ground,V,I,P)
    ...
    sleep_time = {0.0011:10, 0.011:10, 0.19:10, 0.0021:10, 0.023:200, 0.27:10, 0.0031:10, 0.38:10, 0.0048:10, 0.052:10, 0.53:10, 0.76:10, 0.0078:10, 0.083:10, 0.134:100, 1.06:100, 1.51:10, 2.12:10, 2.99:10, 4.24:10, 5.99:10, 8.45:10, 11.9:10, 16.9:10, 23.8:10, 33.7:10, 47.54:10, 67.2:10, 94.7:10, 134:10, 189:10}
    ...
    for k in f_dc:
        t1_dc += measuring_time[k]
        t2_dc += sleep_time[k]
    for j in f_ac:
        t1_ac += measuring_time[j]
        t2_ac += sleep_time[j]

    print(f'Time estimation: ')
    print(f'DC coupling: {(t1_dc+t2_dc)/3600}h')
    print(f'AC coupling: {(t1_ac+t2_ac)/3600}h')

    fscan(dir,sr1,f_dc,f,sleep_time,"DC", index)

    fscan(dir,sr1,f_ac,f,sleep_time,"AC", index + 10) # the +10 in because of an indexing issue. It stops the index from reseting
